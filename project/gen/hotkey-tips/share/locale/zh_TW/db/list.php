...
/*
	...
	$item['Action'] = "Xfce 重新載入設定";
	$list[] = $item;

	$item = array();
	$item['Keybind'] = "Alt + Ctrl + c";
	$item['Action'] = "Xfce 重新啟動";
	$list[] = $item;
*/
...
*/
	...
	$item['Action'] = "開啟系統設定 (xfce4-settings-manager)";
	$list[] = $item;

	$item = array();
	$item['Keybind'] = "Alt + Ctrl + s";
	$item['Action'] = "開啟系統設定值編輯器 (xfce4-settings-editor)";
	$list[] = $item;

	$item = array();
	$item['Keybind'] = "Win + Shift + s";
	$item['Action'] = "開啟視窗管理器設定 (xfwm4-settings)";
	$list[] = $item;

	$item = array();
	$item['Keybind'] = "Win + Ctrl + s";
	$item['Action'] = "開啟外觀設定 (xfce4-appearance-settings)";
	$list[] = $item;

	$item = array();
	$item['Keybind'] = "Ctrl + Esc";
	$item['Action'] = "開啟程序管理器 (xfce4-taskmanager)";
	$list[] = $item;

	$item = array();
	$item['Keybind'] = "Win + p";
	$item['Action'] = "開啟螢幕解析度設定 (xfce4-display-settings --minimal)";
	$list[] = $item;
	...
	$item['Action'] = "開啟 Terminal (xterm)";
	$list[] = $item;

	$item = array();
	$item['Keybind'] = "Alt + Ctrl + t";
	$item['Action'] = "開啟 Terminal (urxvt)";
	$list[] = $item;
